            ...
            <div className="flex gap-x-1.5 justify-center">
              ...
              <div className="py-2 px-4 bg-[#212121]">
                {language === "en"
                  ...
                  : "tekan sekali untuk memindahkan objek ke posisi depan"}
              </div>
              <div className="py-2 px-4 bg-[#212121]">
                {language === "en"
                  ? "click and drag to move object anywhere"
                  : "tekan lalu seret untuk memindahkan objek kemana saja"}
              </div>
            </div>
          </div>
        </div>
