...
const CaseCard = ({ title, nav, desc, categories, intImg, intText, intImg2, intText2, extImg, extText, url1, url2, url3, obj, motionText, maskTexture, srcTexture }) => {
  ...
  return (
    <div ref={ref} className={`transition-opacity duration-700 ${inView ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="hidden lg:flex gap-x-2 items-end">
        {/* Komponen Informasi */}
        <div className={`${cardStyles} h-[481px] lg:max-w-[380px] xl:w-[500px] justify-end p-4 gap-y-6`}>
