...
export const dropdownOutter = 'bg-[#141414] md:min-w-[200px] overflow-hidden shadow-xl shadow-black/40 rounded-lg border border-neutral-800 absolute rounded-lg z-20';
export const dropdownButton = 'px-3 py-3 hover:bg-[#333] cursor-pointer text-white text-start';

export const paragraphText = 'text-[14px] md:text-[15px] text-justify leading-relaxed text-white';
