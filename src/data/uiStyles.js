...
export const dropdownOutter = 'bg-[#141414] min-w-[200px] overflow-hidden shadow-xl shadow-black/40 rounded-lg border border-neutral-800 absolute rounded-lg z-20';
